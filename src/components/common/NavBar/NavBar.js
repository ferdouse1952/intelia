      ...
      <nav className="my-navbar navbar navbar-expand-lg">
        <div className="container-fluid">
          <Link to='/' className="navbar-brand" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" width="104" height="30" viewBox="0 0 104 30"><g fill="none" fill-rule="evenodd">
        ...
        <g stroke="#0FBDCE" stroke-width="2">
          ...
          <button
            className="d-lg-none toggleBar navbar-toggler"
            type="button"
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ms-auto mb-2  mb-lg-0">
              <li className="nav-item">
                <Link to='/' className="text-white nav-link active" aria-current="page" href="#">
                  Home
                </Link>
              </li>
              <li className="nav-item">
                <Link to='showcase' className="text-white nav-link" href="#">
                  Showcase
                </Link>
              </li>
              <li className="nav-item">
                <Link to='testimonial' className="text-white nav-link" href="#">
                Testimonial
                </Link>
              </li>
              <li className="nav-item">
                <Link to='services' className="text-white nav-link" href="#">
                  Our Service
                </Link>
              </li>
             </ul>
          ...
          <button
            className="d-none d-lg-flex toggleBar navbar-toggler"
            type="button"
            data-bs-toggle="collapse"
            data-bs-target="#navbarSupportedContent"
            aria-controls="navbarSupportedContent"
